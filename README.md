...
then re-enable synchronization.<br>
Note that this is not necessary with either<br>
&nbsp;&nbsp;&nbsp;&nbsp;syncMonitorObs: true in constants.ts<br>
or<br>
&nbsp;&nbsp;&nbsp;&nbsp;updated code of manual-sorting - Kh4f already implemented this on the branch
<a href="https://github.com/kh4f/manual-sorting/tree/fix/sync-conflict">fix/sync-conflict</a>
"Skip saving settings to data.json when updateOrder() is triggered by workspace layout ready
(since it’s not really necessary anyway, and during sync it only causes trouble)."
